...
public class MethodStatusUpdateEventNode extends MethodStatusUpdateEventNodeBase {
  
  /** 
   * NodeBuilder uses this, you should not call this yourself. 
   */
  protected MethodStatusUpdateEventNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName, LocalizedText displayName) {
