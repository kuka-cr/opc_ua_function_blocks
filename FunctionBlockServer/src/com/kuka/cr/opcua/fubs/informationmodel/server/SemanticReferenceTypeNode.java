...
public class SemanticReferenceTypeNode extends SemanticReferenceTypeNodeBase {
  
  /** 
   * NodeBuilder uses this, you should not call this yourself. 
   */
  protected SemanticReferenceTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName, LocalizedText displayName) {
