...
public class ViperVarGroupNode extends ViperVarGroupNodeBase {
  
  /** 
   * NodeBuilder uses this, you should not call this yourself. 
   */
  protected ViperVarGroupNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName, LocalizedText displayName) {
